...
extern void messages_afficher_etat( const etat_coureur_t );

/* Affichage d'un message de requete d un coureur au PC Course */
extern void messages_afficher_requete( requete_t * const );

/* Affichage d'un message de reponse du PC Course */
extern void messages_afficher_reponse( reponse_t * const );

/* Affichage du parcours de la course */
extern void messages_afficher_parcours( reponse_t * const );
